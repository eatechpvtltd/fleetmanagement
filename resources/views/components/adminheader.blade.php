        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{URL::to('/admin')}}">
              ...
              <li class="nav-item">
                <a class="nav-link"  href="{{URL::to('Organization')}}" aria-expanded="false" aria-controls="ui-basic">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{URL::to('Group')}}" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{URL::to('Vehicle')}}" aria-expanded="false" aria-controls="ui-basic">
              <i class="icon-layout menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{URL::to('Sites')}}" aria-expanded="false" aria-controls="auth">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{URL::to('Device')}}" aria-expanded="false" aria-controls="auth">
              <i class="icon-head menu-icon"></i>
              <span class="menu-title">GPSDEVICE</span>
